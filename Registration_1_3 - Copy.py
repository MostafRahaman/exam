...
class Reg():
    registration_url = "http://dashboard.nexivent.com/login"
    expected_redirect_url = "http://dashboard.nexivent.com/dashboard"
    def loginTest_001(self):
        ...
        if driver.current_url == expected_redirect_url:
            print("Registration successful! Redirected to the expected page.")
        else:
            print("Registration successful, but not redirected to the expected page.")
        driver.close()
test_obj = Reg()
